      ...
      <div className="flex justify-center">
        <div className="grid grid-cols-3 md:grid-cols-6 gap-8">
          <div className="flex flex-col items-center">
            <BsBriefcase className="w-12 h-12" />
