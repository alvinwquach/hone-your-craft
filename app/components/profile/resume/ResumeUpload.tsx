    ...
    <div className="flex flex-col lg:flex-row justify-center gap-6 p-6 sm:p-8 mt-4 sm:mt-0 bg-zinc-900 border-2 border-zinc-700 rounded-lg max-w-[calc(100vw-13rem)] mx-auto">
      ...
      >
        ...
        <label
          ...
          className={`flex flex-col items-center justify-center w-full h-36 border-2 border-zinc-700 border-dashed rounded-lg cursor-pointer bg-zinc-800 transition-colors relative ${
