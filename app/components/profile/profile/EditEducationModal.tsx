...
interface EditEducationModalProps {
  ...
  updateEducation: (updatedEducation: any) => void;
}
...
function EditEducationModal({
  ...
  const {
    ...
    defaultValues: {
      ...
      major: education.majors[0],
      minor: education.minor,
      startMonth: months[education.startDateMonth - 1],
      startYear: education.startDateYear.toString(),
      endMonth: months[education.endDateMonth - 1],
      endYear: education.endDateYear.toString(),
  ...
  const onSubmit = async (data: EducationFormValues) => {
    const updatedEducation = {
      id: education.id,
      school: data.school,
      majors: data.major ? [data.major] : undefined,
      minor: data.minor,
      startDateMonth: data.startMonth
        ? months.indexOf(data.startMonth) + 1
        : undefined,
      startDateYear: parseInt(data.startYear),
      endDateMonth: data.endMonth
        ? months.indexOf(data.endMonth) + 1
        : undefined,
