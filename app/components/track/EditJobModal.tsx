...
function EditJobModal({ isOpen, closeModal, job, id }: EditJobModalProps) {
  ...
  const [activeModal, setActiveModal] = useState<
    "edit" | "interview" | "rejection" | "offer" | null
  >("edit");
  const modalRef = useRef<HTMLDivElement>(null);

  useEffect(() => {
    if (job && activeModal === "edit") {
  ...
  }, [isOpen, activeModal, closeModal, isSubmitting]);
  ...
  const openModal = (modal: "interview" | "rejection" | "offer") =>
    setActiveModal(modal);
  const closeSecondaryModal = () => setActiveModal("edit");
          ...
          {activeModal === "edit" && (
            ...
            >
              <div className="fixed inset-0 flex items-center justify-center">
                <div
                  className="bg-white rounded-lg shadow-xl w-full max-w-xl p-6 flex flex-col md:flex-row max-h-[80vh] overflow-y-auto"
                  ref={modalRef}
                >
                  <form
                    onSubmit={handleSubmit(onSubmit)}
                    className="flex-grow flex flex-col mr-2"
                  >
                        ...
                        <div className="flex flex-row gap-2 mb-2">
                          ...
                          >
                            <span className="hover:text-primary-500">
                              <RiCalendarCheckLine className="inline-block" />{" "}
                              Log Interview
                            </span>
                          </button>
                          <button
                          ...
                          >
                            <span className="hover:text-primary-500">
                              <LuCircleDollarSign className="inline-block" />{" "}
                              Log Offer
                            </span>
                          </button>
                        </div>
